...
def findCompletedItems(keywords=None, \
                      categoryId=None, \
                      affiliate=None, \
                      buyerPostalCode=None, \
                      paginationInput = None, \
                      ...
                      outputSelector=None, \
                      encoding="JSON"):
    root = etree.Element("findCompletedItems", xmlns="http://www.ebay.com/marketplace/search/v1/services")
    ...
    request = etree.tostring(root, pretty_print=True)
    return get_response(findCompletedItems.__name__, request, encoding)
